...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FKinectAvailabilityChangedEvent, bool, KinectAvailable);
...
public:
	...
	void KinectAvailabilityChanged(bool available);
	...
	UPROPERTY(BlueprintAssignable, Category = "Kinect|EventDispatchers")
	FKinectAvailabilityChangedEvent OnKinectAvailabilityChanged;
